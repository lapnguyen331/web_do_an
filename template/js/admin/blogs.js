...
const data_tables = new DataTable('#table_blogs', {
    ajax: '/template/admin/blogs.txt',
    language: translate,
    dom: 'tip',
    scrollCollapse: true,
    scrollY: '300px',
                ...
                const html = `
                    <div class="category-wrap d-flex align-items-center gap-2">
                        ...
                        <div class="category-info d-flex flex-column justify-content-center">
                            ...
                            <div class="fw-light">Mã bài viết: ${row['id']}</div>
                        </div>
                    </div>
                `
                return html;
        ...
        },
        {
            ...
            render: function(data) {
                ...
                <div class="action-btns">
                    <a href="/template/blog-edit.html?category=${data.id}" data-mdb-toggle="tooltip" title="Chỉnh sửa danh mục">
                        <i class="fa-solid fa-edit view-btn" data-product-id = 'VZ120001'></i>
                    </a>
                    <i class="fa-solid fa-circle-xmark remove-btn" data-mdb-toggle="tooltip" title="Xóa bài viết"></i>
                </div>
                `
                return html;
            }
