...
<section id="login">
    <div class="container">
        <div class="form-box login">
            <h2>Đăng nhập</h2>
            <form id="login-form" action="uploader" method="post" enctype="multipart/form-data">
                <div id="uploader"></div>
                <button type="submit" class="btn d-flex align-items-center justify-content-center gap-2 mt-4">
                    <span>Upload</span>
                </button>
...
<script src="${pageContext.request.contextPath}/libs/image-uploader/image-uploader.min.js"></script>
<script>
