...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/admin-customers.css">
...
<%@ include file="/WEB-INF/view/admin/shared/sidebar.jsp" %>
        ...
        <div class="main-content">
            <div class="customers-control">
                <div class="container rounded-2">
                            ...
                            <div class="col-auto ps-0">
                                <div class="bg-gold bg-sharp-no-left">
                                    <div class="bg-primary-red-main-color px-3 py-1">
                                        <div class="fw-bold text-wheat-color fs-5 text-center">Quản lí khách hàng</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto p-0 py-2">
                                <a href="${pageContext.request.contextPath}/admin/customers_edit"
                        ...
                        <div class="col-md-12">
                            <form id="table_filters">
                                <div class="form-outline input-field">
                                    ...
                                    <input type="text" class="form-control" id="filter_input" placeholder="Theo tên khách hàng, tên đăng nhập và tương tự ...">
                                </div>
                                <div class="form-outline input-field">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table_customers" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>Tên đăng nhập</th>
    ...
    <script src="${pageContext.request.contextPath}/js/admin/customers.js?v=12"></script>
</body>
