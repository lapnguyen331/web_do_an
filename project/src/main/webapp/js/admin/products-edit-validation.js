function validateProductForm() {
    ...
    var imagesProduct = document.getElementById('images_gallery_product').querySelectorAll('img');
    ...
    if (imagesProduct.length === 0) {
        displayErrorMessage('Vui lòng chọn ít nhất một hình ảnh cho thư viện.');
        return false;
    }
    if (priceProduct === '' || isNaN(priceProduct) || parseFloat(priceProduct) <= 100000) {
