...
public class UserRowMapper extends ARowMapper<User> {
    ...
    public User map(ResultSet rs, StatementContext ctx) throws SQLException {
        ...
        return new User(id, username, password, avatar, levelAccess, firstName, lastname, gender, address, phone, birth  == null ? null : Date.valueOf(birth), status, email, verified, createAt, updateAt);
    }
}
